...
# Step 2: Filter other CSV files based on the extracted IDs
def filter_csv_files(ids_file, csv_files, csv_path):
...
def main():
    ...
    # Filter other CSV files based on the extracted IDs
    filter_csv_files(filtered_ids_path, csv_files, csv_path)

    print("Filtering complete. Filtered files are saved with 'filtered_' prefix.")
